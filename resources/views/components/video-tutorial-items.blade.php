    ...
    <div class="bg-white rounded-lg mb-10">
        ...
        <section x-data="{
            ...
            <div class="flex flex-wrap justify-center">
                <div class="w-full aspect-video relative z-20">
                    ...
                    <div class="w-full h-full absolute top-0 left-0 p-3">
                        <img src="https://i.ytimg.com/vi/{{ $videoId }}/original.jpg"
                            alt="image"
            ...
            <div x-show="videoOpen" x-transition
                class="fixed top-0 left-0 w-full h-screen flex items-center justify-center z-50 bg-opacity-70">
                <div @click.outside="videoOpen = false; url = '' " class="w-11/12 md:w-10/12 xl:w-8/12 mx-auto">
                    <iframe
                ...
                {{-- Close button --}}
                {{-- <button @click="videoOpen = false" class="absolute top-0 right-0 w-20 h-20 flex items-center 
                    justify-center cursor-pointer text-body-color hover:bg-black">
        ...
        <div class="p-6 xl:p-7 2xl:p-9 h-[320px] overflow-hidden text-center">
            <h3>
                <a href="https://youtube/{{ $videoId }}" target="_blank " class="font-bold text-dark text-lg mb-4 block hover:text-primary">
                    {{ $title }}
                </a>
            </h3>
