{{-- Contact form using Ajax and AlpineJS --}}
            ...
            <div class="w-full lg:w-1/2 xl:w-6/12 px-4">
                <div class="max-w-[570px] mb-12 lg:mb-0">
                    ...
                    <div class="mb-8 flex w-full max-w-[370px]">
                        <div class="bg-primary text-primary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center 
                    ...
                    <form action="/contact/submit" method="POST" x-data="{
                        ...
                        <div class="mb-6">
                            <x-form.input placeholder="{{ __('messages.form-name') }}" name="name" x-model="formData.name" 
                                ::class="errors.name ? 'border-red-500' : '' " class="text-dark">
                            </x-form.input>
                            {{-- Error message --}}
                        ...
                        <div class="mb-6">
                            <x-form.input type="email" placeholder="{{ __('messages.form-email') }}" name="email" x-model="formData.email" 
                                ::class="errors.email ? 'border-red-500' : '' " class="text-dark">
                            </x-form.input>
                            {{-- Error message --}}
                        ...
                        <div class="mb-6">
                            <x-form.textarea placeholder="{{ __('messages.form-message') }}" name="message" rows="6" x-model="formData.message" 
                                ::class="errors.message ? 'border-red-500' : '' " class="text-dark">
                            </x-form.textarea>
                            {{-- Error message --}}
